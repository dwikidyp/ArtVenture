...
class KaryaseniPolicy
{
    ...
    {
        return $user->can('view_any_karyaseni');
    }
    ...
    {
        return $user->can('view_karyaseni');
    }
    ...
    {
        return $user->can('create_karyaseni');
    }
    ...
    {
        return $user->can('update_karyaseni');
    }
    ...
    {
        return $user->can('delete_karyaseni');
    }
    ...
    {
        return $user->can('delete_any_karyaseni');
    }
